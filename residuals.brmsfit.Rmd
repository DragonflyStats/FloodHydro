...
method Indicates the method to compute model impliedvalues. Either "fitted" (predicted
#### Values of the regression curve) or "predict" (predicted responsevalues).
...
predictedvalues in the original order (FALSE; default) or in the order of the time
series (TRUE).
